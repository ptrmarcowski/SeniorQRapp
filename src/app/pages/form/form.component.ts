...
export class Form implements OnInit {
    ...
    ngOnInit(): void {
        this.mainService.getUserDataById(this.mainService.getCurrentUserId()).subscribe(r => {
            ...
            this.otherAllergiesList = this.userData.otherAllergies.length ? this.userData.otherAllergies.split(';') : null;            
    ...
    public saveForm() {
        ...
        this.userData.hiv = this.formValues.hivVisibility.value;
        this.userData.wzw = this.formValues.wzwVisibility.value;               
